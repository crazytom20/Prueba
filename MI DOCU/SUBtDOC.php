...
<div class="container">
        ...
        <form action="reg.php" method="post">
                        ...
                        <label for="subtipodoc">SubTipo de Documento</label>
                        <input type="text" class="form-control"  name="subtipodoc" id="subtipodoc"required placeholder="SubTipo de Documento">      
                            </div>
