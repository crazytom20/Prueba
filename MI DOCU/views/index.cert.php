	...
	<a href="home.php" class="regresar"><i class="fa fa-long-arrow-left"></i> Regresar</a>
		<div class="contenedor">
			...
			<?php foreach($fotos as $foto):?>
				<div class="thumb">
					<a href="fotos.php?id_documento=<?php echo $foto['id_documento']; ?>?>">
			...
			<div class="paginacion">
				<?php if ($pagina_actual > 1): ?>
					<a href="certificados.php?p=<?php echo $pagina_actual - 1; ?>" class="izquierda"><i class="fa fa-long-arrow-left"></i> Pagina Anterior</a>
				<?php endif ?>

				<?php if ($total_paginas != $pagina_actual): ?>
					<a href="certificados.php?p=<?php echo $pagina_actual + 1; ?>" class="derecha">Pagina Siguiente <i class="fa fa-long-arrow-right"></i></a>
				<?php endif ?>
